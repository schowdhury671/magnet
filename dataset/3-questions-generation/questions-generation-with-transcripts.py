...
# IMPORTANT NOTE: DEPENDENCY ON THIS folder "segmented-subtitles" which should be within the same directory
effort = "low"
...
input_instructions_file = "questions-generation-with-transcripts.py"
...
output_file_path = os.path.join(output_directory, "input_questions3.txt")
